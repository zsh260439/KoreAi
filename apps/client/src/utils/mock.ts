      ...
      toolCalls: [
        {
          ...
          steps: ['解析“明天下午”的相对时间', '映射到 Asia/Shanghai 时区', '校准目标日期与时段'],
          tokens: 36
        },
        {
          id: 'tool-weather-1',
          ...
          outputPreview: '14:00-17:00 时段多云转小雨，降水概率约 60%，存在会务受天气影响的风险',
          summary: '查询上海未来 24 小时天气',
          steps: ['查询小时级天气', '抽取 14:00-17:00 时段', '评估降雨概率与天气变化', '生成会务风险结论'],
          tokens: 88
        }
      ]
    }
